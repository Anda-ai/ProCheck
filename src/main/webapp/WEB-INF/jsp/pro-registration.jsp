...
<body>
  <div class="form-wrapper w-form">
    <c:if test="${slide==1 || slide==null}">
      <form:form action="register_BusinessDetails" method="post" id="Slide1-form-register" class="page-auth"  modelAttribute="business">
        <div class="slider">
    ...
    <c:if test="${slide==2}">
      <form:form action="register_ProfileDetails" method="post" id="Slide2-form-register" class="page-auth"  modelAttribute="profile">
        <div class="slider">
