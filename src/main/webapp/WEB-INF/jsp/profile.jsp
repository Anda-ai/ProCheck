...
<!--TODO:--><%@ taglib uri = "http://java.sun.com/jsp/jstl/core" prefix = "c" %>
      ...
      <div class="form-wrapper">
        <div class="form-banner pro">
          <div class="column desk-3 tab-6 _w-dyn-item prof">
            ...
            <a href="#" class="card pros absolute prof w-inline-block"><!--TODO:--><img src="/profile?u=${user.username}" loading="lazy" alt="" class="image-cover pro">
              <div class="divider pro"></div>
              <!--TODO:--><h3 class="profile-name">${user.firstname} ${user.lastname}</h3>
              <!--TODO:--><c:if test="${pro!=null}">
                <!--TODO:--><h1 class="profile-title">${pro.mainservice.getJSONObject(0).getString("servicename")}</h1> 
              </c:if>
              <!--TODO:--><h1 class="profile-title follow">${user.followers} followers</h1>
              <!--TODO:--><c:if test="${pro!=null}"> 
                ...
                <div class="ratting-wrapper link"> 
                  <!--TODO:--><div id="pro-avg-rating" class="text-block-129">${pro.reviews}</div>
            ...
            <!--TODO:--><c:if test="${pro!=null}"> 
              <div class="pros-profile-section">
                <div id="companyname-wrapper" class="form-wrap">
                  ...
                  <!--TODO:--><p class="form-paragraph pro">${pro.about}.<br></p>
                </div>
                <div id="companyname-wrapper" class="form-wrap no-space">
                  <div id="companyname-wrapper" class="form-wrap row-wrapper no-space pro">
                    ...
                    <!--TODO:--><p class="form-paragraph pro">${pro.mainservice.getJSONObject(0).getString("servicename")}<br></p>
                  </div>
                  <div id="companyname-wrapper" class="form-wrap no-space pro">
                    <p class="form-paragraph pro label">Other services:<br></p>
                    <!--TODO:--><c:forEach begin="0" end="${pro.otherservices.length() -1}" var="i">
                      <!--TODO:--><p class="form-paragraph pro service">${pro.otherservices.getJSONObject(i).getString("servicename")}<br></p>
                    </c:forEach>
                  </div>
